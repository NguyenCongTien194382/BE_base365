...
const Controllers = require("../../../controllers/crm/Customer/ScheduleAutoCall");
...
router.post("/CreateHistoryAutoCall", formData.parse(), Controllers.CreateHistoryAutoCall)

router.post("/UpdateTextAutoCall", formData.parse(), Controllers.UpdateTextAutoCall)

router.post("/GetStorageAutoCall", formData.parse(), Controllers.GetStorageAutoCall)
